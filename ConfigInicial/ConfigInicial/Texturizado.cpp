...
int main()
{
	...
	//elemento 2 text, con 2 valores de coordenadas. 8 flotantes por vertices, desplazamiento que tendra un atributo de su comienzo a donde termina
	glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 8 * sizeof(GLfloat), (GLvoid *)(6 * sizeof(GLfloat)));
	glEnableVertexAttribArray(2); //habilitamos
	glBindVertexArray(0);//inicializamos
	...
	stbi_set_flip_vertically_on_load(true); //voltea textura para que este de la esq inf izq a sup der
	unsigned char *image;
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Bind diffuse map
		glActiveTexture(GL_TEXTURE0);	//Se activa el uso de las texturas
		glBindTexture(GL_TEXTURE_2D, texture1); 
